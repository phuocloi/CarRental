...
namespace CarRentalWebService.Controllers
{
    public class CarBrandsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name")] CarBrand carBrand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name")] CarBrand carBrand)
        {
            if (ModelState.IsValid)
            {
                db.Entry(carBrand).State = System.Data.Entity.EntityState.Modified;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(carBrand);
